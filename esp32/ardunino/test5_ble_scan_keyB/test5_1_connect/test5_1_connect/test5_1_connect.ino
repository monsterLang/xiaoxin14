...
void setup()
{
    ...
    // 创建一个 BLE 设备
    BLEDevice::init("Youkai");//在这里面是ble的名称
...
//        txValue++;                                // 指针数值自加1
        ...
        sensorValue = analogRead(A_SOUND);
        Serial.println(txValue_2);
//        Serial.print("\t");
//        Serial.println(sensorValue);
        delay(1);                              // 如果有太多包要发送，蓝牙会堵塞
    }

//    Serial.println("judge disconnect");
...
//    Serial.println("judge connecting");
    // connecting  正在连接
    if (deviceConnected && !oldDeviceConnected)
    {
